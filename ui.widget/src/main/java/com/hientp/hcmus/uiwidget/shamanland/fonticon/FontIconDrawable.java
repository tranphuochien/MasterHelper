...
import com.hientp.hcmus.uiwidget.shamanland.fonticon.CompoundDrawables;
...
public class FontIconDrawable extends Drawable {
    ...
    public void inflate(Context context, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        try {
            mText = a.getString(R.styleable.FontIconDrawable_iconText);
            if (mText == null) {
                mText = "";
            }

            mTextColor = a.getColorStateList(R.styleable.FontIconDrawable_iconColor);
            if (mTextColor == null) {
                mTextColor = ColorStateList.valueOf(0);
            }

            mTextSize = a.getDimension(R.styleable.FontIconDrawable_iconFontSize, 9f);
    ...
    protected void updatePaint(boolean updateBounds, boolean forcedInvalidate) {
    ...
    private static class MethodGetLayoutDirection {
