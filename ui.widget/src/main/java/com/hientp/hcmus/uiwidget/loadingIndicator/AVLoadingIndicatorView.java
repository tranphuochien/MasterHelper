package com.hientp.hcmus.uiwidget.loadingIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    public static int DEFAULT_SCREEN = 20;
    //attrs
    int mIndicatorId;
    int mIndicatorColor;
    Paint mPaint;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        DEFAULT_SCREEN = getResources().getDimensionPixelSize(R.dimen.zpw_text_size_dot);
        a.recycle();
        mPaint = new Paint();
